...
# kb转为ke_env
# input_filename = '../../Countries/Countries_S1/kb.txt'
# output_filename = '../../Countries/Countries_S1/kb_env.txt'
input_filename = '../../YAGO3-10/kb.txt'
output_filename = '../../YAGO3-10/kb_env.txt'
def convert_and_save(input_filename, output_filename):
	with open(input_filename, 'r') as infile, open(output_filename, 'w') as outfile:
		for line in infile:
			...
			if len(parts) == 3:
				ent1, rel, ent2 = parts
				# 写入正向关系
				outfile.write(f"{ent1}\t{ent2}\t{rel}\n")
				# 写入逆向关系
				outfile.write(f"{ent2}\t{ent1}\t{rel}_inv\n")
