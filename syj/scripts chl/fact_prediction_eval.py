...
relation = "playsFor"
# dataPath_ = '../Countries/Countries_S1/'  + relation
# featurePath = dataPath_ + '/path_to_use.txt'
# feature_stats = dataPath_ + '/path_stats.txt'
# relationId_path ='../Countries/Countries_S1/' + 'relation2id.txt'
# ent_id_path = '../Countries/Countries_S1/' + 'entity2id.txt'
# rel_id_path = '../Countries/Countries_S1/' + 'relation2id.txt'
# test_data_path = '../Countries/Countries_S1/'  + relation + '/train.pairs'
dataPath_ = '../YAGO3-10/'  + relation.replace("/", "@")
featurePath = dataPath_ + '/path_to_use.txt'
feature_stats = dataPath_ + '/path_stats.txt'
relationId_path ='../YAGO3-10/' + 'relation2id.txt'
ent_id_path = '../YAGO3-10/' + 'entity2id.txt'
rel_id_path = '../YAGO3-10/' + 'relation2id.txt'
test_data_path = '../YAGO3-10/'  + relation.replace("/", "@") + '/test.pairs'
HIT_k = 1
...
for i in range(HIT_k):
	...
	rank_stats_rls.append(rank_stats_rl)
...
print('MAP: ', ap3)
print('RL HIT@k: ', correct/len(rank_stats_rl))
